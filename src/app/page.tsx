...
export default function Index() {
  ...
  return (
    <main className="mt-[48px] md:mt-[64px] mb-[64px] md:mb-[96px] px-[16px]">
      <h1 className="md:w-[576px] md:mx-auto text-[40px] md:text-[56px] font-sans mb-[64px] md:mb-[96px]">
        ANDREW
        <br />
        PEIRS
      </h1>
      ...
      <div className="flex flex-col gap-[48px]">
        {allPosts.map((post, index) => {
          ...
          return (
            <div key={post.week} className="group md:flex md:gap-[32px]">
              ...
              <div className="w-auto md:w-[576px] mx-auto">
                ...
                <p className="mt-[12px] mb-[24px] leading-relaxed">
                  {post.excerpt}
                </p>
